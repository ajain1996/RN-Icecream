...
import { Modal, StyleSheet, Text, View, TouchableHighlight, Image, ScrollView } from "react-native";
            ...
            >
                <TouchableHighlight style={styles.centeredView} onPress={() => { callback() }} underlayColor="transparent">
                    <View style={styles.modalView}>
                        <View style={{ width: SIZES.width / 1.2, backgroundColor: COLORS.theme, marginTop: -35 }}>
                            <View style={{ padding: 30, paddingVertical: 40, marginBottom: 8 }}>
                                {userData?.userProfile !== undefined
                                    ? <Image
                                        source={{ uri: userData?.userProfile }} resizeMode="contain"
