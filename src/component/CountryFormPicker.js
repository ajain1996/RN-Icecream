...
export default class CountryFormPicker extends React.Component {
    constructor(props) {
        super(props);
    ...
    setPickerValue(newValue, statesData) {
        this.setState({
            pickerSelection: newValue,
            _placeholderColor: true,
        });

        this.props.onDateSelected(newValue, statesData);
                                ...
                                {this?.props?.data?.map((val, index) => {
                                    return (
                                        <TouchableHighlight
                                            ...
                                            onPress={() => {
                                                this.setPickerValue(val?.name, val?.states);
                                                this.setState({
                                                    isPress: false,
